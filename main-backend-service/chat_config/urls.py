...
from .views import CreateChatWithDatasetView, ChatDetailView, GenerateChatNameView, UpdateChatNameView,FetchTablePreviewAPIView

urlpatterns = [
    path("chat-list-create/", CreateChatWithDatasetView.as_view(), name="chat-list-create"),
    path("fetch-table-preview/",FetchTablePreviewAPIView.as_view(), name="fetch-table-preview"),
