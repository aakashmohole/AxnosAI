...
from .views import (
    CreateChatWithDatasetView, ChatDetailView, GenerateChatNameView, 
    ListUserChatsView, UpdateChatNameView, FetchTablePreviewAPIView,
    UpdateTableNameView
)
...
urlpatterns = [
    ...
    path("chat-update-table/<int:pk>/", UpdateTableNameView.as_view(), name="chat-update-table"),
